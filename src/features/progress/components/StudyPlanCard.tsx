...
import type { WeeklyActivityDay } from '@/features/dashboard/data';
...
// The full Study Plan detail: everything Home's compact StatsRow chips
// leave out (exam readiness, the today/week stat grid, the 7-day activity
// chart). This is what "View study plan" on Home, and the Progress tab's
// own header, both point to — Study Plan and Progress share one screen
// rather than living in separate tabs, since they're really the same
// underlying picture of "how is studying going."
